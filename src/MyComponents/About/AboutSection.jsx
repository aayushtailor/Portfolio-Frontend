...
export default function AboutSection() {
  const skills = [
    ...
    },
    {
      ...
      items: ["Responsive Design", "UI Basics", "Bootstrap", "Tailwind CSS"],
    },
    {
      category: "Tools & Platforms",
      items: ["Git", "GitHub", "Firebase", "Vercel", "VS Code"],
    },
    {
      category: "Learning / Exploring",
      items: ["MongoDB", "Express.js", "API Integration", "Deployment"],
    },
  ];
          ...
          <div className="pr-0 md:pr-6">
            ...
            >
              <p className="text-xl leading-relaxed">
                I'm a creative and passionate developer who loves turning ideas
                into meaningful, user-focused digital experiences — preferably
                with a strong Wi-Fi connection and a good cup of coffee.
              </p>

              <p className="text-gray-600">
                Starting out in UI design gave me a deep appreciation for clean
                visuals and intuitive user experiences. Over time, that passion
                naturally evolved into frontend development, and eventually,
                full-stack problem solving.
              </p>

              <p className="text-gray-600">
                I enjoy building modern web applications that balance
                performance, accessibility, and aesthetics — the kind of
                products that not only look good but actually make life easier
                for users.
              </p>

              <p className="text-gray-600">
                When I'm not coding, you'll probably find me exploring new tech
                trends, tweaking side projects, or convincing VS Code that the
                error is definitely not my fault.
              </p>
